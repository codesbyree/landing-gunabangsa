...
export default function Navigation() {
  return (
    <div className="fixed top-0 left-0 z-1000 flex w-full justify-center bg-white/30 backdrop-blur-sm">
      <div className="flex w-full max-w-7xl items-center justify-between gap-4">
        <a href="/">
          <img
            src="/assets/images/conference-logo.png"
            alt="logo"
            className="h-12 w-34 mix-blend-difference"
          />
        </a>
